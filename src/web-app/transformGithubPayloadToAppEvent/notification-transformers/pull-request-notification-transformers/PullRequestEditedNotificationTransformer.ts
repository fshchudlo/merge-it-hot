import { PullRequestModifiedEvent } from "../../../../core/event-contracts";
import {
...
export class PullRequestEditedNotificationTransformer implements GitHubNotificationTransformer {
    ...
    async transform(payload: GitHubPullRequestEditedNotification, userIdResolver: SlackUserIdResolver, githubAPI: GitHubAPI): Promise<PullRequestModifiedEvent> {
        return {
