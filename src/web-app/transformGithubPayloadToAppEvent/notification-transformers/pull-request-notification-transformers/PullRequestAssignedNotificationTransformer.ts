...
export class PullRequestAssignedNotificationTransformer implements GitHubNotificationTransformer {
    ...
    async transform(payload: GitHubPullRequestAssigneesUpdatedNotification, userIdResolver: SlackUserIdResolver, githubAPI: GitHubAPI): Promise<PullRequestParticipantsUpdatedEvent> {
        return {
