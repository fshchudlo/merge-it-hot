import { PullRequestGenericEvent } from "../../../../core/event-contracts";
...
export class PullRequestClosedNotificationTransformer implements GitHubNotificationTransformer {
    matches(eventType: GitHubPullRequestEventType, payload: GitHubNotification): boolean {
        return eventType == "pull_request" && payload.action == "closed";
    }
