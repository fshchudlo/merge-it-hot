import { link, section, contextBlock, italic } from "@slack-building-blocks";
import { snapshotPullRequestState } from "../internals";
...
function buildMessage(payload: PullRequestGenericEvent): SendMessageArguments {
    ...
    return {
        text: messageTitle,
        blocks: [section(messageTitle), contextBlock(targetText), reviewersContextBlock, section(invitationText)].filter(b => !!b),
