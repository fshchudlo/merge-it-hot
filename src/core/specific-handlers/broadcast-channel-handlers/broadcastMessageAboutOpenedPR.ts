...
export async function broadcastMessageAboutOpenedPR(
...
function buildMessage(payload: PullRequestGenericEvent): SendMessageArguments {
    ...
    const reviewersContextBlock =
        participants.length == 0
            ? null
            : contextBlock(`Assigned reviewers: ${participants.join(",")}.`);
    ...
    return {
        ...
        blocks: [
            ...
            contextBlock(targetText),
            reviewersContextBlock,
